...
# HONEST BASELINES 2026-07 (the only numbers that count)

**2026-07-16, Phase 1 of RESTART-PLAN.md.** Every number below was generated by the
knowability-fixed engine (KNOWABILITY.md: adverseFlipTs +60s, ltLevels/calendar-spread
at-or-before, closed-FVG slice, no GEX future fallback, BE/trailing/time-exit slippage)
on causal data (`data/gex/nq-cbbo-causal` or the causally-regenerated `data/gex/nq`,
as-of IV labels). **Every gold below this section is historical reference only.**
Bar applied (Drew): PF ≥ 1.3 book-quality, positive every year, or it's dead.
JSONs: `data/gold-standard/honest-2026-07/`.

| Strategy | Window | n | PnL | WR | PF | Sharpe | MaxDD | VERDICT |
|---|---|---:|---:|---:|---:|---:|---:|---|
| **DWF v1** (zone/h120/t45) | 2025-02→2026-01 | 272 | $27,422 | 55.5% | 1.33 | 2.11 | 6.59% | **ALIVE** — exact gold reproduction; in-sample only, OOS purchase = gate |
| **DWF v1.1-B** (+min-dte0 0.16) | same | 183 | $25,758 | 56.8% | 1.47 | 2.28 | 3.83% | **ALIVE** — best risk-adjusted config; same OOS gate |
| **GLF v2** | 2025-01→2026-06 | 797 | $86,765 | 24.0% | 1.30 | 3.01 | 11.72% | **ALIVE-THIN** — all 6 qtrs green but 2026 = ~$600/mo (2025 $80.7k vs 2026 $6.1k) |
| ISG (iv-skew-gex) | 2025-01→2026-06 | 228 | $46,870 | 44.7% | 1.32 | 1.68 | 15.47% | **DEAD** — 3 straight losing qtrs (25Q4→26Q2), 2026 negative |
| LGPR v1 | 2023-03→2026-06 | 607 | $87,564 | 58.8% | 1.26 | 1.35 | 12.88% | **DEAD** — was PF 2.04: edge was largely future-LT-row binding (fix #2); worst qtr = latest |
| LGPR v1-ES | 2023-03→2026-06 | 95 | $46,117 | 68.4% | 2.15 | 1.30 | 11.55% | **MARGINAL** — was PF 5.10/DD 3.2%; all years +, but thin (0.7 tr/wk), Sharpe 1.3 |
| First-hour T5 (s_r/50/30/20) | 2025-01→2026-04 | 74 | −$4,390 | 55.4% | 0.79 | — | — | **DEAD** — 1s-honest fills; 1m sim claimed WR 71.6/PF 1.68 (causal) |
| First-hour T7-A (aligned-gap break) | same | 97 | −$1,730 | 78.4% | 0.95 | — | — | **DEAD** — 1s-honest; needs 79.3% WR to break even, 1m sim claimed 87-94% |
| First-hour T8 (gap×regime) | — | — | — | — | — | — | — | **PRESUMED DEAD** — same 1m sim machinery, tighter stops, n=33; not re-verified |
| LSTB (all variants) | — | — | — | — | 0.87 | — | — | **DEAD** (2026-07-15 adverse-cancel lookahead; salvage exhausted) |
| SDIV / GFI | — | — | — | — | 0.80 / 0.98 | — | — | **DEAD** (prior audits, unchanged) |
| GLX v3 | — | — | — | — | — | — | — | **NOT RERUN** — on hold: needs re-tune on causal ladder + live-LT parity gap resolution |

**1s verifiers** (independent implementations, RESTART-PLAN Phase 2.2):
`research/first-hour/verify-T5-1s.py`, `verify-T7A-1s.py` — entry-bar exclusion,
from-fill-instant exits, conservative same-bar resolution, house slippage.

**Bottom line 2026-07-16:** no deployable core exists today. DWF is the only genuine
candidate (mechanism-grounded, placebo-controlled, honest engine) and is gated on
(1) ~$150-200 TCBBO OOS extension, then (2) ~$199/mo live options tape (LS/LT proxy
for dealer sign tested NULL — `research/dealer-flow/12-ls-lt-dealer-sign-probe.py`).
GLF-thin and v1-ES are bench-grade diversifiers, not foundations. Per Drew's
2026-07-16 directive, further research proceeds GREENFIELD (RESTART-PLAN.md Phase 3).
